...
public class PrimaryMembershipPurchasePage extends Page {

    @FindBy(xpath = "//*[@id=\"mat-radio-2\"]/label/div[2]/div/div[2]")
    private WebElement primaryElement;

    public IfbRadioButton primaryradiobutton = new IfbRadioButton(driver, primaryElement);
    ...
    @FindBy(xpath = "//*[@id=\"mat-radio-10\"]/label")
    ...
    @FindBy(xpath = "//*[@id=\"nameOnCreditCard\"]")
    private WebElement ccnameElement;

    public IfbTextBox ccnametextbox = new IfbTextBox(driver, ccnameElement);

    @FindBy(xpath = "//*[@id=\"zipcode\"]")
    private WebElement cczipcodeElement;

    public IfbTextBox cczipcodetextbox = new IfbTextBox(driver, cczipcodeElement);

    @FindBy(xpath = "//*[@id=\"cardNumber\"]")
    private WebElement cccardnumberElement;

    public IfbTextBox cccardnubertextbox = new IfbTextBox(driver, cccardnumberElement);

    @FindBy(xpath = "//*[@id=\"month\"]")
    private WebElement ccexpmonthElement;

    public IfbDropDown ccexpmonthdropdown = new IfbDropDown(driver, ccexpmonthElement);

    @FindBy(xpath = "//*[@id=\"year\"]")
    private WebElement ccexpyearElement;

    public IfbDropDown ccexpyeardropdown = new IfbDropDown(driver, ccexpyearElement);

    @FindBy(xpath = "//*[@id=\"cvv\"]")
    private WebElement cccvvElement;

    public IfbTextBox cccvvtextbox = new IfbTextBox(driver, cccvvElement);

    @FindBy(xpath = "//*[@id=\"saveButtonId\"]")
    private WebElement ccnextElement;

    public IfbButton ccnextbutton = new IfbButton(driver, ccnextElement);
    ...
    public PrimaryMembershipPurchasePage(WebDriver driver) {
